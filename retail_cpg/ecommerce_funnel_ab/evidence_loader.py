#!/usr/bin/env python3
"""Load evidence files into ecommerce funnel A/B testing database."""
...
def main() -> None:
    ...
    # Load A/B testing best practices JSON
    practices_path = evidence_dir / "ab_testing_best_practices.json"
    if practices_path.exists():
        ...
        conn.execute(
            ...
            ("ab_testing_best_practices", practices_data)
        )
